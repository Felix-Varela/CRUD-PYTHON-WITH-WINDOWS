...
class Ventana(Frame):
    ...
    def create_widgets(self):
        ...
        self.btnNuevo.place(x=5, y=50, width=80, height=30) #ubicación del boton y tamaño
        
        
        self.btnModificar = Button(frame1, text="Modificar", command=self.fModificar, bg="blue", fg="white")
        self.btnModificar.place(x=5, y=90, width=80, height=30) #ubicación del boton y tamaño
        
        
        self.btnEliminar = Button(frame1, text="Eliminar", command=self.fEliminar, bg="blue", fg="white")
        self.btnEliminar.place(x=5, y=130, width=80, height=30) #ubicación del boton y tamaño
